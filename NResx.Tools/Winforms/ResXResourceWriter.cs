...
namespace NResx.Tools.Winforms
{
    ...
    public class ResXResourceWriter : IResourceWriter
    {
        ...
        internal const string WriterTypeName = "System.Resources.ResXResourceWriter, System.Windows.Forms, Version=5.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089";
        internal const string ReaderTypeName = "System.Resources.ResXResourceReader, System.Windows.Forms, Version=5.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089";
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        private void InitializeWriter()
        {
            ...
            _xmlTextWriter.WriteStartElement(ResHeaderStr);
            {
                ...
                _xmlTextWriter.WriteStartElement(ValueStr);
                {
                    //_xmlTextWriter.WriteString(MultitargetUtil.GetAssemblyQualifiedName(typeof(ResXResourceReader), _typeNameConverter).ToSystemNamespace());
                    _xmlTextWriter.WriteString(ReaderTypeName);
                }
            ...
            _xmlTextWriter.WriteStartElement(ResHeaderStr);
            {
                ...
                _xmlTextWriter.WriteStartElement(ValueStr);
                {
                    //_xmlTextWriter.WriteString(MultitargetUtil.GetAssemblyQualifiedName(typeof(ResXResourceWriter), _typeNameConverter).ToSystemNamespace());
                    _xmlTextWriter.WriteString(WriterTypeName);
                }
