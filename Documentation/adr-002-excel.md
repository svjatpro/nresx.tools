...
| Технологія                                                                           | Працює без MSExcel | Зручність використання  | Активна підтримка  | Підтримка формул   | Швидкість роботи   | Можливість друку   | Вартість       | Обмеження |
|--------------------------------------------------------------------------------------|--------------------| ------------------------|--------------------|--------------------|--------------------|--------------------|----------------|-----------|
| [**Syncfusion**](https://www.syncfusion.com/document-processing/excel-framework/net) | :heavy_check_mark: | :heavy_check_mark:      | :heavy_check_mark: | :heavy_check_mark: | **Висока (2100ms)**| :heavy_check_mark: | :heavy_check_mark: **Comunity edition** | Компанія з річним дохідом <3 млн$ |
| [**Spire.Xls**](https://www.e-iceblue.com/Introduce/excel-for-net-introduce.html)    | :heavy_check_mark: | :heavy_check_mark:      | :heavy_check_mark: | :heavy_check_mark: | **Висока (1800ms)**| :heavy_check_mark: | :heavy_check_mark: **Free edition with restrictions** | 200 rows, 3 sheets (doesn't work) |
| [**Spreadsheetgear**](https://www.spreadsheetgear.com/)                              | :heavy_check_mark: |                         | :heavy_check_mark: | :heavy_check_mark: |                    | :heavy_check_mark: | :heavy_check_mark: **Free edition with restrictions** | 1000 rows, 3 sheets |
...
| [SmartXLS](https://www.smartxls.com/index.htm)                                       | :heavy_check_mark: |                         | :heavy_check_mark: | :heavy_check_mark: |                    | :x:                | :x: Commercial opensource      |
| OpenXML                                                                              | :heavy_check_mark: |                         | :heavy_check_mark: | :heavy_check_mark: |                    | :x:                | :heavy_check_mark: Безкоштовно |
