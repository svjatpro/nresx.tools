...
З версії 5.х (поточна стабільна версія - 6.х) розповзюджується за ліцензію [https://polyformproject.org/licenses/noncommercial/1.0.0/](PolyForm Noncommercial License 1.0.0), 
